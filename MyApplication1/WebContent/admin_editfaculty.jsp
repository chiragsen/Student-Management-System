        ...
        <table border="1" class="table1">
            ...
            try
            {
            	...
            	Statement st = conn.createStatement();
            		...
            		ResultSet rs=st.executeQuery("select ft_id,ft_fname,ft_designation from faculty");
            		while(rs.next())
            		{
            ...
            <tr>
            <form action="admin_viewfaculty.jsp" method="post">
                <td><input type="text" name="id" value="<%=rs.getString("ft_id")%>"></td>
                <td><input type="text" name="fname" value="<%=rs.getString("ft_fname")%>"></td>
                <td><input type="text" name="course" value="<%=rs.getString("ft_designation")%>"></td>
